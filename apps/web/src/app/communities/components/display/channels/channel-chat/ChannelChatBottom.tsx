...
interface ChannelChatBottomProps {
...
export default function ChannelChatBottom({
  isSubscribed, isOwner, isPrivate, isPending, onSubscribe, onUnsubscribe, onRequest, onCancelRequest, onBroadcast,
}: ChannelChatBottomProps) {
  ...
  // Subscriber / visitor sees subscribe button
  return (
