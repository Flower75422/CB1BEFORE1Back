    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4 items-start">
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="space-y-1">
            <label className="text-[9px] font-black text-stone-400 uppercase tracking-widest ml-1">Group Name</label>
            <input
              type="text"
              value={data.title || ""}
          ...
          <div className="space-y-1">
            <label className="text-[9px] font-black text-stone-400 uppercase tracking-widest ml-1">Group ID</label>
      ...
      <div className="space-y-1">
        <div className="flex justify-between items-center ml-1">
          <label className="text-[9px] font-black text-stone-400 uppercase tracking-widest">Group Bio</label>
