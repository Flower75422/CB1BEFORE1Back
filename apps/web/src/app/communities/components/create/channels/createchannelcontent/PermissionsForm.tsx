  ...
  return (
    <div className="space-y-3 mt-2">
      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <button onClick={() => safeUpdate('allowComments', !perms.allowComments)} className="w-full p-2.5 px-3 rounded-xl bg-[#F5F5F4] border border-transparent hover:border-stone-300 transition-colors flex justify-between items-center shadow-sm">
        ...
        {/* 🔴 NEW: Reactions */}
        <button onClick={() => safeUpdate('allowReactions', !perms.allowReactions)} className="w-full p-2.5 px-3 rounded-xl bg-[#F5F5F4] border border-transparent hover:border-stone-300 transition-colors flex justify-between items-center shadow-sm">
          <div className="flex flex-col items-start text-left flex-1 pr-4">
        ...
        <div className="p-2.5 px-3 rounded-xl bg-[#F5F5F4] flex justify-between items-center border border-transparent hover:border-stone-300 transition-colors shadow-sm">
          <div className="flex flex-col items-start text-left flex-1 pr-4">
            ...
            <span className="text-[9px] font-medium text-[#78716c] mt-0.5 uppercase tracking-tight line-clamp-1">Is this a free or paid channel?</span>
          </div>
          <select 
        ...
        <div className="p-2.5 px-3 rounded-xl bg-[#F5F5F4] flex justify-between items-center border border-transparent hover:border-stone-300 transition-colors shadow-sm">
          <div className="flex flex-col items-start text-left flex-1 pr-4">
            ...
            <span className="text-[9px] font-medium text-[#78716c] mt-0.5 uppercase tracking-tight line-clamp-1">Where this channel is promoted</span>
          </div>
          <select 
